// Generated on 2014-10-05 using generator-jekyllrb 1.2.1
'use strict';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    buildcontrol: {
      dist: {
        options: {
          remote: 'git@github.com:richardwestenra/richardwestenra.github.io.git',
          branch: 'master',
          commit: true,
          push: true
        }
    ...
    modernizr: {
      dist: {
        ...
        dest: '<%= yeoman.dist %>/js/vendor/modernizr.js',
        files: {
          src: [
            '<%= yeoman.app %>/js/{,*/}*.js',
            '<%= yeoman.app %>/_scss/{,*/}*.scss',
